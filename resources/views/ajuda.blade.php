...
<div class="container">
    ...
    <h4>Vizualizando feedback da comunidade:</h4> <br>
        <img class="img-fluid rounded mb-4 animated fadeInRight" src="https://github.com/barbosaGdev/TCC-samu/blob/master/public/images/instrução2.PNG?raw=true" alt="">
    ...
    <h4>Vizualizando colaboradores:</h4> <br>
        <img class="img-fluid rounded mb-4 animated fadeInRight" src="https://github.com/barbosaGdev/TCC-samu/blob/master/public/images/instrucao4.PNG?raw=true" alt="">
    ...
    <h4>Criando um curso:</h4> <br>
        <img class="img-fluid rounded mb-4 animated fadeInRight" src="https://github.com/barbosaGdev/TCC-samu/blob/master/public/images/instrucao5.PNG?raw=true" alt="">
    ...
    <h4>Criando uma notícia:</h4> <br>
        <img class="img-fluid rounded mb-4 animated fadeInRight" src="https://github.com/barbosaGdev/TCC-samu/blob/master/public/images/instrucao6.PNG?raw=true" alt="">
