          ...
          {{ csrf_field() }}
            ...
            <div class="control-group form-group">
              <div class="controls">
                ...
                <input type="text" class="Texto form-control" name="nome" id="nome" required data-validation-required-message="Por Favor , insira seu Nome">
            ...
            <div class="control-group form-group">
              <div class="controls">
                ...
                <input type="tel" class="Texto form-control" pattern="[0-9]+$" name="telefone" id="telefone" required data-validation-required-message="Por Favor , insira seu Número">
              </div>
            </div>
            <div class="control-group form-group">
              <div class="controls">
